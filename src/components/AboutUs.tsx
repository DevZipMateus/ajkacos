        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            animationDelay: '0.2s'
              ...
              Atualmente, há mais de 35 anos no mercado, oferecendo produtos de alta qualidade, provenientes das empresas referências no mercado para garantir segurança dos projetos de nossos clientes. Além de vender mercadorias das mais diversas, oferecemos também serviços de corte em chapas de aço.
            </p>
            <p className="text-gray-600 mb-6 animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
